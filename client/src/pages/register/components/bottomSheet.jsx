    ...
    return (
        <div className={`fixed bottom-0 left-0 w-full h-screen ${showBottomSheet ? 'z-10' : '-z-10'} bg-transparent`}>
            <div
                ...
                className={`relative w-full h-full bg-texts opacity-25 ${showBottomSheet ? 'z-10' : '-z-10'}`}></div>

            <div className={`absolute bottom-0 z-10 left-0 h-[90%] pt-2 pb-4 px-4 w-full rounded-t-xl bg-white ${showBottomSheet ? 'translate-y-0' : 'translate-y-full'} transition-transform duration-300 overflow-y-auto scrollbar-none`}>
                <div className="w-full flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <label htmlFor="productCategory" className="leading-none">Categoría del producto <span className="italic">(Ej: Hamburguesa)</span></label>
                        <Input idFor="productCategory" />
                    </div>
                    <div className="flex flex-col gap-4">
                        <label htmlFor="productName" className="leading-none">Nombre del producto</label>
                        <Input idFor="productName" />
                    </div>
                    <div className="flex gap-6">
                        <div className="flex flex-col gap-4 max-w-[156px]">
                            <label htmlFor="price" className="leading-none">Precio</label>
                            <Input idFor="price" />
                        </div>
                        <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <label htmlFor="description" className="leading-none">Precio</label>
