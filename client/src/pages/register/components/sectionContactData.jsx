    ...
    return (
        <SectionTitle title='Contacto'>
            ...
            <div className="flex flex-col gap-2">
                <label htmlFor="direccion" className="leading-none">Dirección</label>
                <Input idFor="direccion" />
            </div>
            <div className="flex flex-col gap-2">
                <label htmlFor="telefono" className="leading-none">Número de teléfono</label>
                <Input idFor="telefono" />
            </div>
            <div className="flex flex-col gap-2">
                <label htmlFor="facebook" className="leading-none">Facebook</label>
                <Input idFor="facebook" />
            </div>
            <div className="flex flex-col gap-2">
                <label htmlFor="instagram" className="leading-none">Instagram</label>
                <Input idFor="instagram" />
            </div>
            <div className="flex flex-col gap-2">
                <label htmlFor="twitter" className="leading-none">X (Ex Twitter)</label>
                <Input idFor="twitter" />
            </div>
            <div className="flex flex-col gap-2">
                <label htmlFor="whatsapp" className="leading-none">Whatsapp</label>
