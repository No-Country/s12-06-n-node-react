const BottomBar = () => {
	return (
		<div className="w-full h-16 fixed bottom-0 rounded-t-xl bg-yellow-400 desktop:hidden">
			<div className="flex flex-row justify-around content-center h-full">
				<div className="flex flex-col flex-wrap items-center justify-center content-center cursor-pointer">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
				...
				<div className="flex flex-col items-center justify-center content-center cursor-pointer">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
				...
				<div className="flex flex-col items-center justify-center content-center cursor-pointer">
					...
					<span className="text-xs">Mis Tiendas</span>
				</div>
			</div>
		</div>
	);
