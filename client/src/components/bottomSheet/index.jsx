...
export default function BottomSheet({ showBottomSheet }) {
    ...
    return (
        ...
        <div className={`fixed bottom-0 left-0 w-full h-screen ${showBottomSheet ? 'z-10' : '-z-10'} bg-transparent`}>
            ...
            <div className={`absolute bottom-0 z-10 left-[50vw] -translate-x-[50%] h-auto max-h-[416px] pt-2 pb-4 px-4 w-full max-w-[375px] rounded-t-xl bg-white ${showBottomSheet ? 'translate-y-0' : 'translate-y-full'} transition-transform duration-300`}>
                <div className="w-full flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                            <div className={`flex justify-center w-full ${showBottomSheet ? 'cursor-grabbing' : 'cursor-grab'} select-none`}>
                                <span className="h-2 w-[152px] block bg-disabled rounded-full"></span>
                            </div>
                        ...
                        <div className="w-full h-[152px] border border-texts rounded-lg">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-4 text-texts text-sm overflow-y-auto">
                            <p>Pan artesanal de papa. Doble medallón de carne vacuna, doble queso cheddar, doble queso danbo. Tomate, lechuga, chile braseado, salsa Tabasco.</p>
                            <p>Incluye papitas.</p>
                        </div>
                    </div>
                </div>
