function QrIcon({ className }) {
	return (
		...
		>
			...
			<path d="M15 12V15" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M12 18H15" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path
			...
			<path
				...
				strokeLinejoin="round"
			/>
			<path d="M18 3H21V6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M18 21H21V18" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M6 3H3V6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M6 21H3V18" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
		</svg>
	);
}
